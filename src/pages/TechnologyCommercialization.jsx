        ...
        <div className="flex flex-col">
          <div className="flex items-center mb-4">
            <input
              ...
              className="checked:bg-tanglow   radio border-black h-4 w-4 text-black transition duration-150 ease-in-out"
            />
            <label htmlFor="productDevelopment" className="ml-2">
        ...
        <div className="flex flex-col">
          <div className="flex items-center mb-4">
            <input
              ...
              className="checked:bg-tanglow radio border-black h-4 w-4 text-black transition duration-150 ease-in-out"
            />
            <label htmlFor="competitiveLandscape" className="ml-2">
        ...
        <div className="flex flex-col">
          <div className="flex items-center mb-4">
            <input
              ...
              className="checked:bg-tanglow radio border-black h-4 w-4 text-black transition duration-150 ease-in-out"
            />
            <label htmlFor="productDevelopmentDesign" className="ml-2">
        ...
        <div className="flex flex-col">
          <div className="flex items-center mb-4">
            <input
              ...
              className="checked:bg-tanglow radio border-black h-4 w-4 text-black transition duration-150 ease-in-out"
            />
            <label htmlFor="manufacturingSupplyChain" className="ml-2">
